...
export interface Receipt {
  ...
  foreignMatterGr: number | null;
  dirtGr: number | null;
  shellGr: number | null;
  damagedGrainGr: number | null;
  looseGrainGr: number | null;
  aptGrainGr: number | null;
  sampleTotalGr: number | null;
  ...
  industryKg: number | null;
  confectioneryKg: number | null;
